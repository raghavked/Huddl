 ...
 * know who can see your grades, or why a channel appeared by itself. It is
 * plain data so the mobile screen and the web page render the same sentences,
 * the same way the legal documents do.
 *
 * Keep it honest. Every claim below is something the app actually does, and
 * if a behaviour changes this file changes with it. A help page that lies is
 * worse than no help page, because someone will trust it about privacy.
 *
 * The web copy lives at src/lib/help-content.ts and must match word for word.
 */
